...
- [#408](https://github.com/jakubmazanec/tools/pull/408)
  ...
  ([@jakubmazanec](https://github.com/jakubmazanec)) – BREAKING: Zod v4 is now required as a peer
  dependency. Also, function `zodIssueToString` was removed, replace it by Zod's `prettifyError`.

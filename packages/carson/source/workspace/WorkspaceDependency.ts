...
/**
 * Dependency is an external piece of software (e.g. a package) that is installed in a {@link
 * Workspace | a workspace} and usually required by one or more of its {@link Project | projects}.
 */

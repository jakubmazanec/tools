...
▸ **copyWithin**(`target`, `start?`, `end?`): [`RecursiveArray`](lodash.RecursiveArray.md)<`T`\>
...
[`RecursiveArray`](lodash.RecursiveArray.md)<`T`\>
...
▸ **fill**(`value`, `start?`, `end?`): [`RecursiveArray`](lodash.RecursiveArray.md)<`T`\>
...
▸ **filter**(`predicate`, `thisArg?`): ([`RecursiveArray`](lodash.RecursiveArray.md)<`T`\> \| `T`)[]
...
▸ **sort**(`compareFn?`): [`RecursiveArray`](lodash.RecursiveArray.md)<`T`\>
...
▸ **splice**(`start`, `deleteCount?`): ([`RecursiveArray`](lodash.RecursiveArray.md)<`T`\> \| `T`)[]

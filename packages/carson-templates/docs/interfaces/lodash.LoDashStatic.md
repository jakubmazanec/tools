...
[`ArrayIterator`](../modules/lodash.md#arrayiterator)\<`T`, `any`\>) => `T`[](`collection`:
`string`, `iteratee?`: [`StringIterator`](../modules/lodash.md#stringiterator)\<`any`\>) =>
...
TArray\>(`collection`: `TArray` & `undefined` \| `null` \| `T`[], `iteratee?`:
...
TList\>(`collection`: `TList` & `undefined` \| `null` \| [`List`](../modules/lodash.md#list)\<`T`\>,
`iteratee?`: [`ListIterator`](../modules/lodash.md#listiterator)\<`T`, `any`\>) =>
`TList`\<T\>(`collection`: `undefined` \| `null` \| `T`, `iteratee?`:
...
| Name         | Type                                                                          |
| :----------- | :---------------------------------------------------------------------------- |
| `collection` | `TList` & `undefined` \| `null` \| [`List`](../modules/lodash.md#list)\<`T`\> |
| `iteratee?`  | [`ListIterator`](../modules/lodash.md#listiterator)\<`T`, `any`\>             |
...
[`FunctionChain`](lodash.FunctionChain.md)\<`any`\> &
...
▸ **keyBy**\<`T`\>(`collection`, `iteratee?`): [`Dictionary`](lodash.Dictionary.md)\<`T`[keyof
`T`]\>

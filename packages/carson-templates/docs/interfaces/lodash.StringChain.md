...
- [forInRight](lodash.StringChain.md#forinright)
...
- [lowerFirst](lodash.StringChain.md#lowerfirst)
...
- [toPlainObject](lodash.StringChain.md#toplainobject)
...
▸ **plant**(`value`): [`StringChain`](lodash.StringChain.md)
...
▸ **tap**(`interceptor`): [`StringChain`](lodash.StringChain.md)
...
▸ **toPairs**(): [`CollectionChain`](lodash.CollectionChain.md)<[`string`, `string`]\>
...
[`CollectionChain`](lodash.CollectionChain.md)<[`string`, `string`]\>
...
▸ **toPairsIn**(): [`CollectionChain`](lodash.CollectionChain.md)<[`string`, `string`]\>

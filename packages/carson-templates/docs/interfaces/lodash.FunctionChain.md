...
▸ **partial**\<`T3`\>(`plc1`, `plc2`, `arg3`): [`FunctionChain`](lodash.FunctionChain.md)\<`T`
...
[`FunctionChain`](lodash.FunctionChain.md)\<`T` extends (`t1`: `T1`, `t2`: `T2`, `t3`: `T3`,
...`ts`: `TS`) => `R` ? (...`ts`: `TS`) => `R` : `any`\>
...
[`FunctionChain`](lodash.FunctionChain.md)\<`T` extends (...`ts`: `any`[]) => `any` ? `T`\<`T`\> :
`any`\>

...
▸ **extendWith**\<`TSource`\>(`source`, `customizer`): [`Object`](lodash.Object.md)\<`T` &
`TSource`\>
...
▸ **mergeWith**\<`TSource`\>(`source`, `customizer`): [`Object`](lodash.Object.md)\<`T` &
`TSource`\>
...
▸ **pickBy**\<`S`\>(`predicate`):
[`Object`](lodash.Object.md)\<[`NumericDictionary`](lodash.NumericDictionary.md)\<`unknown`\>

...
[packages/error/src/types/CustomError.ts:6](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/types/CustomError.ts#L6)
...
[packages/error/src/types/CustomErrorOptions.ts:4](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/types/CustomErrorOptions.ts#L4)
...
[packages/error/src/types/CustomErrorWithData.ts:6](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/types/CustomErrorWithData.ts#L6)
...
[packages/error/src/types/CustomErrorWithDataOptions.ts:4](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/types/CustomErrorWithDataOptions.ts#L4)
...
[packages/error/src/types/ErrorMessages.ts:4](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/types/ErrorMessages.ts#L4)
...
[packages/error/src/constants.ts:6](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/constants.ts#L6)
...
[packages/error/src/createCustomError.ts:13](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/createCustomError.ts#L13)
...
| :---------- | :------------------------------------------------------------- |
| `ErrorCode` | extends `string`                                               |
| `ErrorData` | extends `ZodObject`<`any`, `any`, `any`, {}, {}, `ErrorData`\> |
...
[packages/error/src/createCustomErrorWithData.ts:21](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/createCustomErrorWithData.ts#L21)
...
[packages/error/src/createCustomErrorWithData.ts:29](https://github.com/jakubmazanec/js-tools/blob/6c3a1f2/packages/error/src/createCustomErrorWithData.ts#L29)

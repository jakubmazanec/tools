 ...
 */
export type CustomErrorWithData<ErrorCode extends string, ErrorData> = Error & {
  /**
   * String that is used to quickly determine the nature of the error and why it could have
   * occurred.
   */

...
> =
  O extends NumbersOptionConfig ?
    ...
    : O['defaultValue'] extends readonly number[] ? number[]
    : number[] | undefined
  ...
  O extends StringsOptionConfig ?
    O['choices'] extends readonly string[] ?
      O['defaultValue'] extends readonly string[] ?
        Array<TupleToUnion<O['choices']>>
      : Array<TupleToUnion<O['choices']>> | undefined
    : O['defaultValue'] extends readonly string[] ? string[]
    : string[] | undefined
...
type OptionConfigToArgumentOption<O extends OptionConfig> =
  O extends BooleanOptionConfig | BooleansOptionConfig ? BooleanOptionConfigToArgumentsOption<O>
  : O extends CountOptionConfig | NumberOptionConfig | NumbersOptionConfig ?
    NumberOptionConfigToArgumentsOption<O>
  : O extends StringOptionConfig | StringsOptionConfig ? StringOptionConfigToArgumentsOption<O>
  : never;
...
/** Parsed options. */
export type ArgumentsOptions<O extends ParserConfig> =
  Omit<O, 'options'> extends O ? null
  : O['options'] extends undefined ? null

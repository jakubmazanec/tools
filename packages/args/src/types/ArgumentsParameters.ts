...
type ParameterConfigToArgumentsParameter<O extends ParameterConfig> =
  O extends NumberParameterConfig
    ? NumberParameterConfigToArgumentsParameter<O>
    : O extends StringParameterConfig
    ? StringParameterConfigToArgumentsParameter<O>
    : O extends BooleanParameterConfig
    ? BooleanParameterConfigToArgumentsParameter<O>
    : never;

type ParametersConfigToArgumentsParameters<O extends ParametersConfig> = O extends readonly [
  ParameterConfig,
  ParameterConfig,
  ParameterConfig,
  ParameterConfig,
  ...
  ? readonly [ParameterConfigToArgumentsParameter<O[0]>]
  : never;
...
/** Parsed parameters. */
export type ArgumentsParameters<O extends ParserConfig> = Omit<O, 'parameters'> extends O
